...
docker build --no-cache --platform linux/amd64 -t crossfeed-worker -f Dockerfile.worker .

docker build --no-cache --platform linux/amd64 -t pe-worker -f Dockerfile.pe .
