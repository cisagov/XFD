...
export class Organization extends BaseEntity {
    ...
    @OneToMany((type) => Domain, (domain) => domain.organization, {onDelete: 'CASCADE',
    onUpdate: 'CASCADE'})
      domains: Domain[];

    @OneToMany((type) => Ip, (ip) => ip.organization, {onDelete: 'CASCADE',
      onUpdate: 'CASCADE'})
        ips: Ip[];
    
    @OneToMany((type) => Ticket, (ticket) => ticket.organization, {onDelete: 'CASCADE',
      onUpdate: 'CASCADE'})
        tickets: Ticket[];
  ...
  @OneToMany((type) => TrustymailScan, (trustymail_scan) => trustymail_scan.organization, {
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })@Column({
        nullable: true,
