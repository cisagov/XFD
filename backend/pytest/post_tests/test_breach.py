# ToDo:
#  POST/apiv1/breachcomp_credsbydate
#  POST/apiv1/breachcomp
#  GET/apiv1/breachcomp_credsbydate/task/{task_id}

# This is massive and need to figure out how to run without crashing API
...
class TestOnline(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/breachcomp_credsbydate"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/breachcomp_credsbydate/task/" + task_id
        ...
        with open("results/breachcomp_credsbydate.json", 'r') as file:
