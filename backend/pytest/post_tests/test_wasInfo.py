...
class TestWasInfo(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/was_info"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/was_info/task" + task_id
        ...
        with open("results/was_info", 'r') as file:
