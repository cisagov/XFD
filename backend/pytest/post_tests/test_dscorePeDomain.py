# TODO
#  POST/apiv1/dscore_pe_domain
#  GET/apiv1/dscore_pe_domain/task/{task_id}
...
class TestOnline(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/dscore_pe_domain"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/dscore_pe_domain/task/" + task_id
        response = requests.post(api_url, json=payload, headers=headers, verify=False)
        ...
        with open("results/dscore_pe_domain.json", 'r') as file:
