# TODO
# POST/apiv1/fceb_status
# GET/apiv1/fceb_status/task/{task_id}
...
class TestOnline(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/fceb_status"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/fceb_status/task/" + task_id
        ...
        with open("results/fceb_status.json", 'r') as file:
