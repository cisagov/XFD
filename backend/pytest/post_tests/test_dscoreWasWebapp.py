# TODO
#  POST/apiv1/dscore_was_webapp
#  GET/apiv1/dscore_was_webapp/task/{task_id}
...
class TestOnline(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/dscore_was_webapp"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/dscore_was_webapp/task/" + task_id
        ...
        with open("results/dscore_was_webapp.json", 'r') as file:
