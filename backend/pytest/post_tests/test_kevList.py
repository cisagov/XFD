# TODO
# POST/apiv1/kev_list
# GET/apiv1/kev_list/task/{task_id}
...
class TestOnline(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/kev_list"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/kev_list/task/" + task_id
        ...
        with open("results/kev_list", 'r') as file:
