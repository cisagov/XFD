# TODO
#  POST/apiv1/dscore_vs_cert
#  GET/apiv1/dscore_vs_cert/task/{task_id}
...
class TestOnline(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/dscore_vs_cert"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/dscore_vs_cert/task/" + task_id
        ...
        with open("results/dscore_vs_cert.json", 'r') as file:
