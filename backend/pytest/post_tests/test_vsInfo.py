# TODO
#  POST/apiv1/vs_info
#  GET/apiv1/vs_info/task/{task_id}

# Figure Out what the sting is supposed to be
...
class TestVeInfo(unittest.TestCase):
    def test_online(self):
        try:
            api_url = "http://127.0.0.1:8089/apiv1/vs_info"
        ...
        api_url = "http://127.0.0.1:8089/apiv1/vs_info/task" + task_id
        ...
        with open("results/vs_info", 'r') as file:
