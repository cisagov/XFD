...
export const TermsOfUse: React.FC = () => {
  ...
  return (
    <AuthForm onSubmit={onSubmit}>
      ...
      <p>
        CyHy Dashboard is a free, self-service tool offered by the Department of
        Homeland Security’s Cybersecurity and Infrastructure Security Agency
        (CISA). Using both passive and active processes, CyHy Dashboard can
      ...
      {maximumRole === 'admin' && (
        <p>
          ...
          evaluated, and select the scanning/evaluation protocols to be used,
          CyHy Dashboard will collect data about the sites you specified from
          multiple publicly-available resources, including through active
          interactions with your sites, if that option is selected by you. CyHy
          Dashboard will also examine any publicly-available,
          internet-accessible resources that appear to be related or otherwise
          associated with IPs or domains you have provided us to evaluate,
          presenting you with a list of those related sites for your awareness.
        </p>
      )}
      <p>
        ...
        vulnerabilities and configuration issues through CyHy Dashboard and
      ...
      <ul>
        {maximumRole === 'admin' && (
          <>
            <li>
              ...
              public-facing networks and systems you submit within CyHy
              Dashboard and you authorize CISA to conduct any such
              scans/evaluation through CyHy Dashboard;
            </li>
            <li>
            ...
            <li>
              ...
              vulnerability scanning services, modifying any CyHy Dashboard
              scans associated with your account if external scanning of those
              resources is later prohibited;
            </li>
            <li>
              You accept that, while CyHy Dashboard will use best efforts to
              conduct scans in a way that minimizes risk to your organization’s
              systems and networks, CyHy Dashboard scanning activities creates
              some risk of degradation in performance to your organization’s
              systems and networks;
            </li>
            <li>
              You agree that CISA may share data gathered by CyHy Dashboard with
        ...
        <li>
          You accept that CISA may modify or discontinue the CyHy Dashboard
          service at any time;
        </li>
        <li>
          You acknowledge that use of CyHy Dashboard is governed exclusively by
          federal law and that CISA provides no warranties of any kind relating
          to any aspect of your use of CyHy Dashboard, including that CyHy
          Dashboard may detect only a limited range of vulnerabilities or
          configuration issues and that there is no guarantee that CyHy
          Dashboard will detect any or all vulnerabilities or configuration
          issues present in your system;
        </li>
        <li>
          You agree to not:
          <ul>
            ...
            <li>
              Access or attempt to access any CyHy Dashboard account other than
              your own; and
            </li>
            <li>
              Introduce malware to the CyHy Dashboard platform or otherwise
              impair, harm, or disrupt the functioning or integrity of the
              platform in any way;
            </li>
          </ul>
        </li>
        <li>
          ...
          suspend your access to the CyHy Dashboard service due to violation of
          these terms or any other reason.
        </li>
      </ul>
