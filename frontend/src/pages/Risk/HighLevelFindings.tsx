...
import { SummaryStats, VulnSummaryStats, VulnerabilityCount } from 'types';
...
const VulnerabilityFindings = (props: {
  ...
  summaryData: undefined | SummaryStats;
  vulnSummaryData: undefined | VulnSummaryStats;
}) => {
  const { title, summaryData, vulnSummaryData } = props;
