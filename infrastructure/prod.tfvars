...
backend_api_log_group_name          = "cyhy-prod-backend-api"
backend_api_requests_log_group_name = "cyhy-prod-backend-api-requests"
is_dmz                              = false
project                             = "Crossfeed"
stage                               = "prod"
...
db_instance_class                   = "db.m7i.4xlarge"
...
ssm_django_env_kms_arn              = "/crossfeed/prod/DJANGO_ENV_KMS_ARN"
ssm_aws_id                          = "/crossfeed/prod/AWS_ACCOUNT_ID"
...
ssm_shodan_ip_chunk_size            = "/crossfeed/prod/SHODAN_IP_CHUNK_SIZE"
ssm_shodan_query_days_back          = "/crossfeed/prod/SHODAN_QUERY_DAYS_BACK"
ssm_pe_shodan_api_keys              = "/crossfeed/prod/PE_SHODAN_API_KEYS"
ssm_wiz_registry_secret_arn         = "/crossfeed/prod/WIZ_REGISTRY_CREDENTIAL_SECRET_ARN"
ssm_wiz_service_account_secret_arn  = "/crossfeed/prod/WIZ_SERVICE_ACCOUNT_SECRET_ARN"
ssm_wiz_http_proxy_cert_secret_arn  = "/crossfeed/prod/WIZ_HTTP_PROXY_CERT_SECRET_ARN"
...
ssm_databricks_server_hostname      = "/crossfeed/prod/DATABRICKS_SERVER_HOSTNAME"
ssm_databricks_warehouse_id         = "/crossfeed/prod/DATABRICKS_WAREHOUSE_ID"
ssm_databricks_client_id            = "/crossfeed/prod/DATABRICKS_CLIENT_ID"
ssm_databricks_client_secret        = "/crossfeed/prod/DATABRICKS_CLIENT_SECRET"
...
ssm_checksum_salt                   = "/crossfeed/prod/CHECKSUM_SALT"
...
ssm_qualys_password                 = "/crossfeed/prod/QUALYS_PASSWORD"
ssm_nist_api_key                    = "/crossfeed/prod/NIST_API_KEY"
ssm_whoisxml_thread_count           = "/crossfeed/prod/WHOIS_XML_THREAD_COUNT"
xpanse_org_sync_bucket_name         = "crossfeed-xpanse-org-sync-prod"
zscaler_cert_bucket_name            = "cisa-crossfeed-prod-zscaler"
