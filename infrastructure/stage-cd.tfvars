...
matomo_force_index_url               = "staging-cd.crossfeed.cyber.dhs.gov/matomo"
...
matomo_availability_zone             = "us-east-1b"
...
ssm_databricks_server_hostname       = "/crossfeed/staging/DATABRICKS_SERVER_HOSTNAME"
ssm_databricks_warehouse_id          = "/crossfeed/staging/DATABRICKS_WAREHOUSE_ID"
ssm_databricks_client_id             = "/crossfeed/staging/DATABRICKS_CLIENT_ID"
ssm_databricks_client_secret         = "/crossfeed/staging/DATABRICKS_CLIENT_SECRET"
...
open_cti_smtp_hostname       = "localhost"
open_cti_censys_org_id       = "c32ad594-953c-40a6-b12d-f2617f1b7085"
open_cti_qualys_api_username = "dhscs3st"
# Confirmed 2026-08-17: XTM One isn't actually active on stage-cd (no
# XTM_ONE_* keys in its real .env). Left empty deliberately -- bootstrap.sh
# treats these two as optional (unlike the five above), so this is the
# expected value, not a placeholder waiting to be filled in. Set for real if
# XTM One is ever turned on here.
open_cti_xtm_one_host                        = ""
open_cti_xtm_one_admin_email                 = ""
