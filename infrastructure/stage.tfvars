adot_python_layer_arn_govcloud     = "arn:aws-us-gov:lambda:us-gov-west-1:263492004256:layer:adot-python-with-collector:1"
...
django_env_bucket_name             = "cyhy-staging-django-env"
...
matomo_force_index_url             = "staging.crossfeed.cyber.dhs.gov/matomo"
sns_topic_alarms                   = "crossfeed-staging-cis-alarms"
ssm_crossfeed_vpc_name             = "/crossfeed/staging/VPC_NAME"
ssm_django_env_kms_arn             = "/crossfeed/staging/DJANGO_ENV_KMS_ARN"
...
ssm_shodan_ip_chunk_size           = "/crossfeed/staging/SHODAN_IP_CHUNK_SIZE"
ssm_shodan_query_days_back         = "/crossfeed/staging/SHODAN_QUERY_DAYS_BACK"
...
open_cti_instance_type             = "m5.4xlarge" # matches stage-cd's real, already-running instance -- confirm availability in this gov-cloud region/AZ before relying on it
# Was unset here (falling back to var.open_cti_host's intentionally-invalid "" default) until
# now -- the live instance's actual OPENCTI_HOST=localhost was coming from open-cti/env.static's
# own hardcoded STABLE IDENTIFIERS line, not from Terraform. VPN access for
# demo-staging-cyber-hygiene.cisa.dhs.gov requires this to be the real external hostname so
# APP__BASE_URL generates correct links -- see open_cti_host's variable description.
open_cti_host                                = "demo-staging-cyber-hygiene.cisa.dhs.gov"
